...
public class AccountManagementView extends BorderPane {
    ...
    private VBox createAccountTablePanel() {
        ...
        TableColumn<Account, String> openedCol = new TableColumn<>("OPENED DATE");
    ...
    private void loadSampleData() {
        ...
        accountTable.getItems().addAll(
            new Account("SAV001", "Savings", "John Doe", "BWP 1,500.00", "Active", "2024-01-15"),
            new Account("INV001", "Investment", "John Doe", "BWP 5,000.00", "Active", "2024-01-20"),
            new Account("CHQ001", "Cheque", "Jane Smith", "BWP 2,500.00", "Active", "2024-02-01"),
            new Account("SAV002", "Savings", "Bob Johnson", "BWP 800.00", "Active", "2024-02-15"),
            new Account("INV002", "Investment", "Alice Brown", "BWP 7,500.00", "Active", "2024-03-01")
        );
    }

    // Inner Account class for table data
    public static class Account {
        ...
        public Account(String accountNumber, String accountType, String customer, String balance, String status, String openedDate) {
